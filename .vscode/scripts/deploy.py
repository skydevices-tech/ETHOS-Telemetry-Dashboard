...
#    json_path = os.path.join(out_dir, "i18n", f"{lang}.json")  # because scripts/inav-dashboard/** got copied already
#    if not os.path.isfile(json_path):
#        # Fallback for local build before copy, if needed:
#        json_path = os.path.join(config['git_src'], "scripts", "inav-dashboard", "i18n", f"{lang}.json")
#    if not os.path.isfile(json_path):
